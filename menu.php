<nav class=" container mt-3 navbar navbar-expand-lg border border-dark rounded" style="background-color:">
    <div class="container-fluid ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu bg-transparent text-body m-2">
                        <li><a class="dropdown-item bg-transparent text-body m-2" href=" categoury.php">categoyry</a></li>
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link  text-dark" href="gallary.php"><i class="bi bi-images"></i> Gallary</a>
                </li> -->
                <li class="nav-item">
            ...
            <form class="d-flex">
                <a class="text-dark m-3 mb-2" href="login.php"><span class="btn btn-success"><i
                            class="bi bi-person-fill"></i> Login</span></a>
            </form>
